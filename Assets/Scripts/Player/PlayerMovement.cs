...
namespace NextTurn
{
  public class PlayerMovement : MonoBehaviour
  {
    ...
    private void Start()
    {
      ...
      _inputActions.Player.Movement.started  += OnMovementInput;
      _inputActions.Player.Movement.canceled += OnMovementInput;
      _inputActions.Player.Jump.started      += OnJumpInput;
      _inputActions.Player.Jump.canceled     += OnJumpUpInput;
    ...
    public void OnMovementInput(Vector2 values)
    {
      _moveInput = values;
    ...
    public void OnJumpUpInput(CallbackContext context)
    {
