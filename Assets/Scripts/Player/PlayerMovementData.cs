...
namespace NextTurn
{
  [CreateAssetMenu(menuName = "Jam/Player Movement Data")] //Create a new playerData object by right clicking in the Project Menu then Create/Player/Player Data and drag onto the player
